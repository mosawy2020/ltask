    ...
    <div class="col-md-7 col-sm-10">
        <div class="contact-form">
            <form  action="{{route('admins.update',$admin->id)}}" method="POST" style="margin-bottom: 150px;">
                ...
                <div class="checkbox">
                    <label><input type="checkbox" name="roles[]"  value="super_admin" {{$admin->hasRole('super_admin') ? 'checked' :'' }}> super admin</label>
                  </div>
                  <div class="checkbox">
                    <label><input type="checkbox" name="roles[]" value="admin" {{$admin->hasRole('admin') ? 'checked' :'' }}> admin </label>
                  </div>
